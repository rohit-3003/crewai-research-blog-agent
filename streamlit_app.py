...
st.set_page_config(
    page_title="AI Research & Blog Generator",
    page_icon="🤖",
    layout="wide"
)

st.title("🤖 Content Research & Writer, powered by CrewAI")
st.markdown("Generate research reports and blog posts using AI agents.")
...
def generate_content(topic):
    ...
    senior_research_analyst = Agent(
        ...
        backstory = "You're an expert research analyst with advanced web research skills. "
                    ...
                    "fact-checking, cross-referencing infornation, and "
    ...
    writing_task = Task(
        ...
        expected_output = """A polished blog post in markdown format that:
                ...
                - Follows proper markdown formatting, use Hl for the title and H3 for the sub-sections""",
